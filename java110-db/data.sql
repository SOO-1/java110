...
--학생회원
insert into p1_stud(sno,schl, work) values(1,'비트대학','N');
insert into p1_stud(sno,schl, work) values(2,'비트대학','Y');
insert into p1_stud(sno,schl, work) values(3,'캠프대학','Y');
insert into p1_stud(sno,schl, work) values(4,'캠프대학','N');
insert into p1_stud(sno,schl, work) values(5,'오호라대학','N');
