...
public class Servlet02 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 출력스트림을 꺼내기 전에 지정해야 한다.
        
        // 오타 조심!!!
        res.setContentType("text/plain;charset=UTF-8");
        // => 서블릿 컨테이너는
        //    이 설정에 따라 출력할 수 있는 출력스트림 객체를 리턴할 것이다.
      ...
      /* Content-Type
       * => text/plain    : MINE 타입 지정
       * => charset=UTF-8 : 출력할 때 사용할 문자표 작성
       ...
       *                   영어는 ISO-8859-1코드 그대로 1바이트로 표현한다. 
       *                   소스코드, html, javascript, text등 모든 저장 시 utf-8!
       */        
    }
