...
public class Servlet21 extends HttpServlet{
    ...
    protected void doGet(
        ...
        //    => 없다면,
        //       없을 때와 똑같이 처리한다.
        // => 없다면, (쿠키가 없거나, 쿠키에 세션 아이디가 없거나)
        //    => 새로 HttpSession 객체를 생성하여 리턴한다.
        //    => 응답할 때 응답 프로토콜의 쿠키 정보로 
        //       새로 생성한 세션 객체의 세션 아이디를 보낸다. (객체의 인스턴스주소X!)
        //    => 웹브라우저는 서버로부터 받은 쿠키 데이터인 세션 ID를
        //       서버에 요청할 때 마다 보낼 것이다.
        
        // 세션ID를 응답 프로토콜로 보내는 예)
        //  => 톰캣 서버에서는 JSESSIONID라는 쿠키 이름으로 세션 아이디를 보낸다.
        //  => WAS마다 세션 ID의 쿠키 이름이 다를 수 있다.
        
        /*
            HTTP/1.1 200
            Set-Cookie: JSESSIONID=32DF2450DF5B81D9B78352072D340558; Path=/; HttpOnly
            Content-Type: text/html;charset=UTF-8
            Content-Length: 142
            Date: Tue, 02 Oct 2018 00:57:21 GMT
        */
