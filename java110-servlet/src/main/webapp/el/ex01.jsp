...
<pre> 
- EL(Expression Language)은 마침표(.)와 대괄호([]) 등을 사용하여 객체의 프로퍼티나,
     리스트, 셋, 앱 객체의 값을 쉽게 꺼내고 설정하기 도와주는 문법이다.
...
- EL에서 사용할 수 있는 객체?
    ...
    requestScope - ${requestpageScope.객체이름}
            =>request.getAttribute("객체이름");
    result - ${requestpageScope.객체이름}
            =>result.getAttribute("객체이름");
    pageScope - ${pageScope.객체이름}
            =>pageContext.getAttribute("객체이름");
