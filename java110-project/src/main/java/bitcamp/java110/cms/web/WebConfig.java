...
// IoC 컨테이너에게 configuration 애노테이션을 통해 알려줌 ( 없으면 인식하지 못함 )
...
public class WebConfig 
    ...
    // 인터페이스의 모든 메서드를 당장 구현할 필요가 없다. (메서드가 default로 되어있음.)
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        // 추가하고 싶은 인터셉터를 등록기(registry)에 추가하라!
