...
public class RequestMappingBeanPostProcessor 
    implements BeanPostProcessor {  // bean 생성 후에 처리, 객체 모두 만든 이후에 beanPostProcessor 이용해 추가적으로 기능 생성
    ...
    public Object postProcessAfterInitialization(
        ...
        System.out.println("[" + beanName + "]"
                + "RequestMappingBeanPostProcessor.postProcessAfterInitialization() 호출됨!");
