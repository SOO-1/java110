...
public class Test13 {
    ...
    public String m1(
            ...
            @RequestParam("tel") String tel, // value는 생략 가능하다
            Model model) {
    ...
    public String m2(
            ...
            @RequestParam(value="tel", required=false) String tel, // required라는 다른 속성을 넣으면서 value라고 정확히 붙여줌
            Model model) {
    ...
    @RequestMapping("m4") 
    public String m4(
            @RequestParam(required=false) String name, // name과 value는 같다.
    ...
    @RequestMapping("m5") 
    public String m5(
            String name, // name과 value는 같다.
            int age, // 기본값이 없기 때문에 값을 정확히 숫자로 넣지 않으면 Error 발생!
            String tel, 
            Model model) {
