...
// request handler가 Model이나 Map 객체에 저장하는 값 중에서 
// 세션에도 저장할 값을 지정할 때 다음 애노테이션을 사용한다.

@SessionAttributes({"name","gender"}) // session에 보관할 값만 지정!
public class Test27 {
    ...
    @ResponseBody
    public String m1(Model model) throws Exception { // 프론트 컨트롤러에게 모델 객체를 담아달라해서 나중에 jsp가 쓸 수 있도록. 
