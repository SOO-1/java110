...
public class MyWebApplicationInitializer 
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        // 2) 각각의 웹 애플리케이션의 /WEB-INF/lib 폴더에 들어있는 .jar 파일을 로딩한다.
        // 3) 각 jar 파일에 대해 다음을 수행한다.
        //      => /META-INF/services 폴더를 찬든다.
        ...
        //         이렇게 하도록 Servlet 기술 명세서에 정의되어 있다.
        //
        ...
        //         SpringServletContextInitializer 클래스 위에 선언한 
        //         @HandlesTypes 애노테이션에 
        ...
        ServletRegistration.Dynamic registration = 
                servletContext.addServlet("app", servlet); // app이라는 이름으로 DispatcherServlet등록
